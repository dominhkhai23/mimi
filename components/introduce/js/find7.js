...
var contentIndex4 = document.querySelector('.content_index7')
var headerIndex4Navbar = document.querySelector('.header_index7-navbar-icon')
...
headerIndex4Navbar.addEventListener('click', () => {
   modalSearch2.classList.add('open')
})
