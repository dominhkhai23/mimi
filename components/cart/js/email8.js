var inputFooter = document.querySelector('.footer_index-input') 
var Btn = document.querySelector('.footer_index-btn')
var errorMessage = document.querySelector('.footer_index-messenger')
