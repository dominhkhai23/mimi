var dataImg = [
    ...
    { 
        img: [
         ...
         img1: 'https://product.hstatic.net/200000696635/product/frame_75_65cc214b036b42d986a20715473471a5.png',
         name:'Áo sơ mi basic - Navy',
         price: 499000,
         color:[
           'Đen',
           'xanh'
    ...
    { 
        img: [
             'https://product.hstatic.net/200000696635/product/frame_6_5cf93ff5333349d5acfb933befbdc052.png',
             'https://product.hstatic.net/200000696635/product/frame_44_cccc5af7fb4342d2839f0cd4878e0f03.png',
         ],
         img1: 'https://product.hstatic.net/200000696635/product/frame_6_5cf93ff5333349d5acfb933befbdc052.png',
         name:'Áo sơ mi Hàn Quốc - Black',
         price:  499000,
         color:[
            'kẻ đen',
            'kẻ xanh',
    ...
    { 
        img: [
             ...
             'https://product.hstatic.net/200000696635/product/frame_20_2f956f09373f439884c381ebc85e8e2e.png',
         ],
         img1: 'https://product.hstatic.net/200000696635/product/frame_45_942f7ab0d26342be836ea4d7a8796b9e.png',
         name: 'Áo sơ mi Hàn Quốc - Blue',
         price: 499000,
         color:[
            'kẻ xanh',
             'kẻ đen'
...
var productEye = document.querySelectorAll('.content_product-eye-link')
