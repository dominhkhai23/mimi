...
var contentIndex6 = document.querySelector('.content_index6')
var headerIndex6Navbar = document.querySelector('.header_index6-navbar-icon')
...
input.addEventListener('keyup', (event) => {
   ...
   switch(event.keyCode) {
      case 13: 
        ...
        contentIndex6.style.display = 'none'
        break;
      }
})
...
headerIndex6Navbar.addEventListener('click', () => {
   modalSearch.classList.remove('close')
})
