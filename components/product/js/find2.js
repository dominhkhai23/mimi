...
var contentIndex2 = document.querySelector('.content_index2')
var headerIndex2Navbar = document.querySelector('.header_index2-navbar-icon')
...
headerIndex2Navbar.addEventListener('click', () => {
   modalSearch.classList.remove('close')
})
